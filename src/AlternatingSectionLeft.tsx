        ...
        <div className="flex justify-start w-full  lg:px-20">
            <div className="relative max-w-5xl mt-10 xl:max-w-6xl">
                ...
                <div className="flex flex-col lg:flex-row justify-center items-center ">
                    ...
                    {/* Text Section */}
                    <div className="max-w-lg bg-green md:max-w-2xl rounded-2xl md:z-10 md:shadow-lg md:absolute md:top-0 md:mt-48 lg:w-1/2 lg:right-0 lg:mt-20 lg:ml-20 xl:mt-24 xl:ml-12">
