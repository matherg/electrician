    ...
    return (
        <div id="main" className="bg-bloo text-white w-full mt-10 h-[80vh] flex items-center justify-center ">
            <div className="text-center">
                ...
                <h2 className="text-5xl text-green font-bold mb-4 ">"Going above and beyond since 2001"</h2>
                <button className="bg-white text-bloo px-6 py-3 rounded-lg">Contact Us</button>
            </div>
        </div>
    );
};
