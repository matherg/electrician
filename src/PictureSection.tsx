...
const PictureSection = () => {
    ...
    const text3 = "Ascent electric is a professional electrical contracting service that has been operating in summit county colorado since 1998. Our service area covers Dillon, Silverthorne, Breckenridge, Frisco, and Eagle-vail.";
    return (
